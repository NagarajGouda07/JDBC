...
public class EmployeeRunner {
	...
	public static void main(String[] args) {
		...
		String insertQuery = "INSERT INTO jali VALUES"
		...
		String selectQuery = "SELECT first_name FROM jali WHERE email='priya.yadav@example.com' AND password='Yadav';";
		String selectQuery1 = "SELECT address FROM jali WHERE first_name='Rahul' AND phone_number='9876543210';";
		String selectQuery2 = "SELECT email, password FROM jali WHERE phone_number='9876543218';";
		String selectQuery3 = "SELECT email, password FROM jali WHERE phone_number='9876543215' AND first_name='Nikhil';";
		String selectQuery4 = "SELECT first_name FROM jali WHERE id > 5";
		...
		try {
			...
			if (resultSet2.next()) {
				...
				System.out.println("Password: " + resultSet2.getString("password"));
			} else {
				System.err.println("Not Found");
			}
			...
			if (resultSet4.next()) {
				System.out.println("First Name: " + resultSet4.getString("first_name"));
			} else {
				System.err.println("Not Found");
			}
